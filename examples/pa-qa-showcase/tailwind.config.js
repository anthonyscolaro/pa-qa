  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'outline-primary': '0 0 0 3px rgb(59 130 246 / 0.5)',
        'outline-error': '0 0 0 3px rgb(239 68 68 / 0.5)',
      ...
      typography: (theme) => ({
        ...
        invert: {
          css: {
            ...
            '--tw-prose-lead': theme('colors.secondary[400]'),
